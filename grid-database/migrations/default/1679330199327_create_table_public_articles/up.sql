CREATE TABLE "public"."articles" ("id" serial NOT NULL, "title" text NOT NULL, "summary" text, "body" text, "status" text NOT NULL DEFAULT 'planned', "type" text NOT NULL, "created_by" integer NOT NULL, "published_at" date, "created_at" timestamptz NOT NULL DEFAULT now(), "updated_at" timestamptz NOT NULL DEFAULT now(), PRIMARY KEY ("id") , FOREIGN KEY ("created_by") REFERENCES "public"."users"("id") ON UPDATE restrict ON DELETE restrict);
